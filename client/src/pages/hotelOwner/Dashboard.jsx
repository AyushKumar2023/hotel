...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Dashboard' subTitle='this is a dashboard if you are owner you can own it if you are not owner toh aap toh aa hi ni skte the ...
         just kidding... pr yrh sach h...'></Title>
