  ...
  return (
    <form action="">
      <Title
        ...
        font="outfit"
        title="Add Room"
        subTitle="Add the room if you haave new room as an Admin
 you have authority to add the room "
      ></Title>
      <p className="text-gray-800 mt-10">Images</p>
      <div
        className="grid grid-cols-2 sm:flex gap-4 my-2 
 flex-wrap"
      >
        {Object.keys(images).map((key) => (
          <label htmlFor={`roomImages${key}`} key={key}>
            <img
              className="max-g-13 cursor-pointer opacity-80"
              src={
                images[key]
